        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-8 items-center w-full">
          ...
          <div className="lg:col-span-7 space-y-8 text-center lg:text-left">
            ...
            <div className="flex flex-col sm:flex-row flex-wrap gap-3 pt-2 justify-center lg:justify-start">
              <TrustBadge icon={<CheckCircle2 className="h-[18px] w-[18px] text-trust" />} text="১০০% অর্গানিক" />
              <TrustBadge icon={<Truck className="h-[18px] w-[18px] text-trust" />} text="ক্যাশ অন ডেলিভারি" />
              <TrustBadge icon={<MapPin className="h-[18px] w-[18px] text-trust" />} text="সারাদেশে ডেলিভারি" />
            </div>
          </div>
...
<div className="inline-flex items-center gap-2.5 rounded-full bg-trust/[0.06] border border-trust/15 px-[18px] py-2.5">
    {icon}
    <span className="font-bangla text-sm text-foreground leading-tight font-bold">{text}</span>
  </div>;
...
<div className="relative p-10">
    ...
    <div className="absolute top-6 right-6 w-[60px] h-[60px] rounded-full bg-trust text-trust-foreground flex flex-col items-center justify-center border-[3px] border-white shadow-soft text-center">
      ...
      <span className="text-[7px] font-bold leading-none font-bangla">অর্গানিক</span>
      <span className="text-[7px] font-bold leading-none font-bangla">সার্টিফাইড</span>
    </div>
  </div>;
